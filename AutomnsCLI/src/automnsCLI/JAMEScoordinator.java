    ...
    public void menu () throws IOException {
        ...
        switch (cmd)
        {
            ...
            case 3:
        		...
        		dest1.addAddresses("http://" + workerVMsPrivate.get(1) +":7778/acc");
        		msg.addReceiver(dest1);
        		//
        		AID dest2 = new AID("image@" + workerVMsPrivate.get(2) +":5003/JADE", AID.ISGUID);
        		dest2.addAddresses("http://" + workerVMsPrivate.get(2) +":7778/acc");
        		msg.addReceiver(dest2);
        		//
        		AID dest3 = new AID("pers@" + workerVMsPrivate.get(3) +":5004/JADE", AID.ISGUID);
        		dest3.addAddresses("http://" + workerVMsPrivate.get(3) +":7778/acc");
        		msg.addReceiver(dest3);
        		//
        		AID dest4 = new AID("recom@" + workerVMsPrivate.get(4) +":5005/JADE", AID.ISGUID);
        		dest4.addAddresses("http://" + workerVMsPrivate.get(4) +":7778/acc");
        		msg.addReceiver(dest4);
        		//
        		AID dest5 = new AID("reg@" + workerVMsPrivate.get(5) +":5006/JADE", AID.ISGUID);
        		dest5.addAddresses("http://" + workerVMsPrivate.get(5) +":7778/acc");
        		msg.addReceiver(dest5);
        		//
        		AID dest6 = new AID("webui@" + workerVMsPrivate.get(6) +":5007/JADE", AID.ISGUID);
        		dest6.addAddresses("http://" + workerVMsPrivate.get(6) +":7778/acc");
