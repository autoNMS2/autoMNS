...
public class coordinator extends Agent {
	public void menu () throws IOException {
		...
		String[] agentCommands = {"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker1.java",
				...
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host " + workerVMsPrivate.get(1) + " -local-port 5000 -container Worker2:automnsCLI.Worker2",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker3.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host " + workerVMsPrivate.get(2) + " -local-port 5001 -container Worker3:automnsCLI.Worker3",
