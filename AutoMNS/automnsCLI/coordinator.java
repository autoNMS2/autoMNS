...
public class coordinator extends Agent {
	public void menu () throws IOException {
		...
		String[] agentCommands = {"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker1.java",
				...
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.19.3 -local-port 5001 -container Worker2:automnsCLI.Worker2",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker3.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.23.132 -local-port 5002 -container Worker3:automnsCLI.Worker3",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker4.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.20.7 -local-port 5003 -container Worker4:automnsCLI.Worker4",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker5.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.30.221 -local-port 5004 -container Worker5:automnsCLI.Worker5",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker6.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.30.16 -local-port 5005 -container Worker6:automnsCLI.Worker6",
				"javac -cp autoMNS/AutoMNS/lib/jade.jar -d classes autoMNS/AutoMNS/automnsCLI/workers/Worker7.java",
				"java -cp autoMNS/AutoMNS/lib/jade.jar:classes jade.Boot -host " + workerVMsPrivate.get(0) + " -port 1099 -local-host 172.31.22.80 -local-port 5006 -container Worker7:automnsCLI.Worker7"};
